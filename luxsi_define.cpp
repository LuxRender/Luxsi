...
XSIPLUGINCALLBACK CStatus LuXSI_Define( CRef& in_ctxt )
{
    ...
    prop.AddParameter( L"use_hidden_obj",   CValue::siBool, sps,L"",L"", true,      dft,dft,dft,dft, oParam );
    prop.AddParameter( L"use_hidden_light", CValue::siBool, sps,L"",L"", true,      dft,dft,dft,dft, oParam );
    prop.AddParameter( L"use_hidden_surf",  CValue::siBool, sps,L"",L"", false,     dft,dft,dft,dft, oParam );
    prop.AddParameter( L"use_hidden_cam",   CValue::siBool, sps,L"",L"", true,      dft,dft,dft,dft, oParam );
    prop.AddParameter( L"smooth_mesh",      CValue::siBool, sps,L"",L"", false,     dft,dft,dft,dft, oParam );
    prop.AddParameter( L"sharp_bound",      CValue::siBool, sps,L"",L"", false,     dft,dft,dft,dft, oParam );
    /**/
    prop.AddParameter( L"bplymesh",         CValue::siBool, sps,L"",L"", false,     dft,dft,dft,dft, oParam );
    prop.AddParameter( L"over_geo",         CValue::siBool, sps,L"",L"", false,     dft,dft,dft,dft, oParam );
    
    
    //----/ image /-->
    prop.AddParameter( L"Width",        CValue::siInt4,  sps,L"",L"", 640,      0l,2048l,0l,1024l,  oParam);
    prop.AddParameter( L"Height",       CValue::siInt4,  sps,L"",L"", 480,      0l,2048l,0l,768l,   oParam);
    prop.AddParameter( L"gamma",        CValue::siFloat, sps,L"",L"", 2.2,      0,10,0,3,           oParam);
    //prop.AddParameter( L"progressive",  CValue::siBool,  sps,L"",L"", vProg,       dft,dft,dft,dft,    oParam);
    
    //-- filter //
    prop.AddParameter( L"bfexpert", CValue::siBool,     sps,L"",L"", false, dft,dft,dft,dft,        oParam );
    ...
    prop.AddParameter( L"ssample",  CValue::siBool,     sps,L"",L"", false, dft,dft,dft,dft,        oParam );
    ...
    prop.AddParameter( L"bsexpert",     CValue::siBool, sps,L"",L"",   false,    dft,dft,dft,dft,    oParam );
    ...
    prop.AddParameter( L"binc_env",     CValue::siBool, sps,L"",L"",  false,    dft,dft,dft,dft,  oParam );
    ...
    prop.AddParameter( L"bdirectsampleall",         CValue::siBool, sps,L"",L"",    false,  dft,dft,dft,dft,    oParam );
    prop.AddParameter( L"bdirectsamples",           CValue::siInt4, sps,L"",L"",    1,      0l,4l,0l,4l,        oParam );
    prop.AddParameter( L"bindirectsampleall",       CValue::siBool, sps,L"",L"",    true,   dft,dft,dft,dft,    oParam );
    ...
    prop.AddParameter( L"bdirectdiffuse",           CValue::siBool, sps,L"",L"",    true,   dft,dft,dft,dft, oParam ) ;
    prop.AddParameter( L"bindirectdiffuse",         CValue::siBool, sps,L"",L"",    true,   dft,dft,dft,dft, oParam ) ;
    ...
    prop.AddParameter( L"bdirectglossy",            CValue::siBool, sps,L"",L"",    true,   dft,dft,dft,dft,  oParam );
    prop.AddParameter( L"bindirectglossy",          CValue::siBool, sps,L"",L"",    true,   dft,dft,dft,dft,  oParam );
    ...
    //--
    prop.AddParameter( L"bdiff_reflect_reject",    CValue::siBool, sps,L"",L"",     false,  dft,dft,dft,dft, oParam );
    prop.AddParameter( L"bdiff_refract_reject",    CValue::siBool, sps,L"",L"",     false,  dft,dft,dft,dft, oParam ); 
    prop.AddParameter( L"bglossy_reflect_reject",  CValue::siBool, sps,L"",L"",     false,  dft,dft,dft,dft, oParam );
    prop.AddParameter( L"bglossy_refract_reject",  CValue::siBool, sps,L"",L"",     false,  dft,dft,dft,dft, oParam );
    ...
    prop.AddParameter( L"bmindist",  CValue::siFloat, sps,L"",L"",    0.10, 0.0,1024.0,0.1f,1024.0,  oParam );
    //--
    //-- exphotonmap
...
//  prop.AddParameter( L"bstrategy",                 CValue::siString, sps, L"", L"",
    ...
    prop.AddParameter( L"bfinalgather",              CValue::siBool, sps,L"",L"",  false,   dft,dft,dft,dft,        oParam );
    ...
    prop.AddParameter( L"bdbg_enabledirect",         CValue::siBool, sps,L"",L"",  false,   dft,dft,dft,dft, oParam );
    prop.AddParameter( L"bdbg_enableradiancemap",    CValue::siBool, sps,L"",L"",  false,   dft,dft,dft,dft, oParam );
    prop.AddParameter( L"bdbg_enableindircaustic",   CValue::siBool, sps,L"",L"",  false,   dft,dft,dft,dft, oParam );
    prop.AddParameter( L"bdbg_enableindirdiffuse",   CValue::siBool, sps,L"",L"",  false,   dft,dft,dft,dft, oParam );
    prop.AddParameter( L"bdbg_enableindirspecular",  CValue::siBool, sps,L"",L"",  false,   dft,dft,dft,dft, oParam );
    ...
    prop.AddParameter( L"bdlsampling",      CValue::siBool,  sps,L"",L"",  false,   dft,dft,dft,dft,        oParam );
    prop.AddParameter( L"bincenvironment",  CValue::siBool,  sps,L"",L"",  false,   dft,dft,dft,dft,        oParam );
    ...
    prop.AddParameter( L"bbasampler",   CValue::siInt4,  sps,L"",L"",   0,        0,10,0,10,  oParam ); // combo

    prop.AddParameter( L"bpresets",     CValue::siInt4, sps,L"",L"",    2,     0,10,0,10,      oParam );

    //-- expert mode menu options
    prop.AddParameter( L"bexpert",      CValue::siBool, sps,L"",L"",    false,  dft,dft,dft,dft, oParam );
    ...
    //--- save image options // 
    prop.AddParameter( L"save_png_16", CValue::siBool, sps,L"",L"", false,  dft,dft,dft,dft, oParam );
    prop.AddParameter( L"png_gamut",   CValue::siBool, sps,L"",L"", false,  dft,dft,dft,dft, oParam );
    prop.AddParameter( L"save_png",    CValue::siBool, sps,L"",L"", true,   dft,dft,dft,dft, oParam );
    ...
    prop.AddParameter( L"save_exr",    CValue::siBool, sps,L"",L"", false,  dft,dft,dft,dft,    oParam );
    //-- tga
    prop.AddParameter( L"mode_rtga",   CValue::siInt4, sps,L"",L"", 1,      0,10,0,10,          oParam );
    prop.AddParameter( L"save_tga",    CValue::siBool, sps,L"",L"", false,  dft,dft,dft,dft,    oParam );
    prop.AddParameter( L"tga_gamut",   CValue::siBool, sps,L"",L"", false,  dft,dft,dft,dft,    oParam );
    //--
    ...
    prop.AddParameter( L"bautode",  CValue::siBool, sps,L"",L"", true,  dft,dft,dft,dft,    oParam );
    ...
    prop.AddParameter( L"bacexpert",           CValue::siBool, sps,L"",L"",  false,     dft,dft,dft,dft,    oParam );
    ...
    prop.AddParameter( L"brefineimmediately",  CValue::siBool, sps,L"",L"",  false,     dft,dft,dft,dft,    oParam );
    ...
    prop.AddParameter( L"resume",   CValue::siBool, sps,L"",L"",  false,    dft,dft,dft,dft,    oParam );
    prop.AddParameter( L"loglevel", CValue::siBool, sps,L"",L"",  false,    dft,dft,dft,dft,    oParam );
